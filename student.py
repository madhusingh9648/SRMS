...
class studentClass:
    def __init__(self,root):
        ...
        cal=DateEntry(self.root,textvariable=self.var_dob,selectmode='day',year=2022,month=7,day=16)
        cal.grid(row=1,column=1,padx=480,pady=65)
        ...
        lbl_self_roll=Label(self.root,text="Roll No.",font=("goudy old style",15,'bold'),bg='lightyellow').place(x=720,y=60)
